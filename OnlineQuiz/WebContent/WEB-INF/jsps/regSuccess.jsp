...
<div id="wrapper">
	...
	<form name="login-form" class="login-form">
		...
		<h3 style="float: left;">Congratulations ${requestScope.newUser}, your account has been created successfully! Please <a href="${pageContext.request.contextPath}/login">login </a>to take an exam.</h3> 
		</div>
